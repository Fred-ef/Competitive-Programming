mod lib;
use lib::find_longest_k_good_segment;
...
fn main() {
    ...
    let k1 = 5;
    let out1 = (0, 4);
    let res1 = find_longest_k_good_segment(arr1, k1);
    ...
    let k2 = 3;
    let out2 = (0, 2);
    let res2 = find_longest_k_good_segment(arr2, k2);
    ...
    let k3 = 1;
    let out3 = (0, 0);
    let res3 = find_longest_k_good_segment(arr3, k3);
